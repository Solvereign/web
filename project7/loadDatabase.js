...
// const {makePasswordEntry, doesPasswordMatch} from './cs142password.js';
const mongoose = require("mongoose");
const passManager = require("./cs142password.js");
...
Promise.all(removePromises)
  .then(function () {
    ...
    const userPromises = userModels.map(function (user) {
		const passObj = passManager.makePasswordEntry("weak");
