...
class Example extends React.Component {
    ...
    return (
      <div className="container Example">
        ...
        <p>
          ...
          &nbsp; named <span className="cs142-code-name">Example</span>. It is
          ...
          named <span className="cs142-code-name">render</span>, which appears
        ...
        <p>
          ...
          <code>({"{this.state.counter}"})</code> displays the state.counter
        ...
        <p>
          ...
          posssible output lines based on an argument to the function and uses a
  ...
  return retVal;
        ...
        <p>
          ...
          <code>{"{this.outOfBandJSX(true)}"}</code>) would be expand to:
        </p>
        <div className="cs142-example-output">{this.outOfBandJSX(true)}</div>
        {/* <div className="cs142-example-output">{this.outOfBandJSX(false)}</div> */}
        <p>
  ...
  <ul>
    {[0,1,2].map((i) =>  <li key={i}>List Item {i}</li>)}
        ...
        <p>
          ...
          sentence appear between to two paragraph when some characters are
...
<input type="text" value={this.state.inputValue} onChange={this.handleChangeBound} />`}
        ...
        <p>
          ...
          calls the function this.handleChangedBound every time the input field
          is changed. Typically this kind of input will be associated with a{" "}
          <a href="https://reactjs.org/docs/handling-events.html">Button</a> or
          inside a <a href="https://reactjs.org/docs/forms.html">Form</a> to
          allow the user to signal when they are finished changing the input
          field. Note the differences from HTML in <code>onchange=</code> become{" "}
        ...
        <p>
          ...
          value of the DOM element so its value can be access like{" "}
          <code>{"{this.state.inputValue}"}</code> which returns &nbsp;&ldquo;{" "}
          {this.state.inputValue} &rdquo;. Note we can not directly call{" "}
          <code>this.handleChange</code> since it is a method function of an
          object that is not available to the DOM. To handle this we create a
          new function <code>this.handleChangeBound</code> that can call the
          method and use it here.
        </p>
        <p>
          If we want to pass arguments to event handling functions we can use
          inlined arrow function definitions like so:
        </p>
        <pre className="cs142-example-code">
          <code className="language-jsx">
            {`<div className="cs142-example-output">
  ...
  >
    Call handleButtonClick function with two
        ...
        <p>
          ...
          then call the method <code>handleButtonClick</code> with the specified
          argument.
        </p>
        <div className="cs142-example-output">
          <p>
            ...
            {this.state.buttonWasClicked && (
              <span>
                Last button clicked was: {this.state.buttonWasClicked}
              </span>
            )}
          </p>
          <button
